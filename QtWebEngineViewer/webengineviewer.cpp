...
QMainWindow *WebEnginePage::mainWindow()
{
...
bool WebEnginePage::acceptNavigationRequest(QWebEngineFrame *frame, const QNetworkRequest &request, NavigationType type)
{
...
public:
        ...
        , m_view(new WebEngineView(this))
    {
        ...
        connect(m_view, &WebEngineView::titleChanged, this, &QWidget::setWindowTitle);
        connect(m_view, &WebEngineView::urlChanged, this, &PopupWindow::setUrl);
        connect(page(), &WebEnginePage::geometryChangeRequested, this, &PopupWindow::adjustGeometry);
        connect(page(), &WebEnginePage::windowCloseRequested, this, &QWidget::close);
    }
...
QObject *WebEnginePage::createPlugin(const QString &classId, const QUrl &url, const QStringList &paramNames, const QStringList &paramValues)
{
    Q_UNUSED(url);
    Q_UNUSED(paramNames);
...
void WebEnginePage::authenticationRequired(const QUrl &requestUrl, QAuthenticator *auth)
{
//    BrowserMainWindow *mainWindow = BrowserApplication::instance()->mainWindow();
//
...
void WebEnginePage::proxyAuthenticationRequired(const QUrl &requestUrl, QAuthenticator *auth, const QString &proxyHost)
{
//    Q_UNUSED(requestUrl);
//    BrowserMainWindow *mainWindow = BrowserApplication::instance()->mainWindow();
//
...
#endif
    connect(page(), &WebEnginePage::featurePermissionRequested, this, &WebEngineView::onFeaturePermissionRequested);
#if defined(QWEBENGINEPAGE_UNSUPPORTEDCONTENT)
...
void WebEngineView::openLinkInNewTab()
{
...
void WebEngineView::onFeaturePermissionRequested(const QUrl &securityOrigin, QWebEnginePage::Feature feature)
{
...
void WebEngineView::setProgress(int progress)
{
    m_progress = progress;
}

void WebEngineView::loadFinished(bool success)
{
...
QString WebEngineView::lastStatusBarText() const
{
    return m_statusBarText;
}

QUrl WebEngineView::url() const
{
...
QIcon WebEngineView::icon() const
{
    if (!m_icon.isNull())
        return m_icon;
...
void WebEngineView::onIconUrlChanged(const QUrl &url)
{
...
void WebEngineView::setStatusBarText(const QString &string)
{
    m_statusBarText = string;
}

void WebEngineView::downloadRequested(const QNetworkRequest &request)
{
